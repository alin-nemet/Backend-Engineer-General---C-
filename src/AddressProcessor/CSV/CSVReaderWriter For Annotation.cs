...
namespace AddressProcessing.CSV
{
    /*
        ...
        Please leave the rest of this file as it is so we can discuss your concerns during 
        ...
        *) Open method can take an interface as parameter (fileName and Mode would be exposed through it),
           which would be make it testable since we can mock/stub an interface
        *) Same as above for WriteLineOfWordsSeparatedByTabs, Read and Close, and also give them more meaningful names, based on their purpose. Class name can be better also.
    */
